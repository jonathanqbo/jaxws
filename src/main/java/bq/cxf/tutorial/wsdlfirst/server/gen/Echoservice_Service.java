...
public class Echoservice_Service extends Service {
    ...
    static {
        URL url = Echoservice_Service.class.getResource("src/main/resource/bq/cxf/tutorial/wsdlfirst/echoservice.wsdl");
        if (url == null) {
            url = Echoservice_Service.class.getClassLoader().getResource("src/main/resource/bq/cxf/tutorial/wsdlfirst/echoservice.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Echoservice_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/resource/bq/cxf/tutorial/wsdlfirst/echoservice.wsdl");
        }       
        WSDL_LOCATION = url;
    }
