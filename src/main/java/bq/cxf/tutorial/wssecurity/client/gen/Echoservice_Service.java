 ...
 * 2014-02-26T16:55:23.854-05:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "echoservice", 
                  wsdlLocation = "http://localhost:8080/jaxws/ws/securityechoservice?wsdl",
...
public class Echoservice_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/jaxws/ws/securityechoservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Echoservice_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/jaxws/ws/securityechoservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
